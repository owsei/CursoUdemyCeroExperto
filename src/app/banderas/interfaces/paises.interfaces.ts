...
//
//   const banderasResponse = Convert.toBanderasResponse(json);
//
...
export class Convert {
    public static toBanderasResponse(json: string): BanderasResponse[] {
        return cast(JSON.parse(json), a(r("BanderasResponse")));
    }

    public static banderasResponseToJson(value: BanderasResponse[]): string {
        return JSON.stringify(uncast(value, a(r("BanderasResponse"))), null, 2);
    }
}
